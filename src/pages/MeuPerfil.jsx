...
export const MeuPerfil = () => {
    return (
        <header className="flex  bg-[url('assets/img/Fundo.png')] opa bg-cover bg-center flex-col justify-center items-center h-full">
            ...
            <div className=" flex flex-col justify-center text-center pt-12 items-center h-full w-auto">
                ...
                <div className="pt-4 flex-1 text-black font-semibold   ">
                    <div className=" text-sm flex flex-col ">
                        ...
                        <div className="text-[8px] ">Contato: <span className="font-bold tracking-[0.7px]">bernardosantosmagalhaesm@gmail.com</span></div>
                    </div>
                </div>

                <div className=" w-full p-4 flex flex-col flex-1">
                    <NavLink className="bg-slate-400 mb-4 p-2 shadow-md shadow-black rounded-3xl text-base font-bold  border-black hover:scale-95 border-2 border-solid" href="https://github.com/BernardoSant">
                        <a  href="https://github.com/BernardoSant">Curriculo</a>
                    </NavLink>
